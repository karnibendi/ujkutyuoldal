  ...
  function localizeDataForEnglish() {
    ...
    const gadgetCopy = {
      'pizza-ollo': {
        ...
        review: { quote: 'I still eat with cutlery — just with dramatically better slice geometry.', author: 'Robert, enthusiastic home host' },
      },
      'spagetti-mero': {
        ...
        review: { quote: 'I used to cook emotionally. Now I cook with measurable confidence.', author: 'Zsofi, amateur Italian' },
      },
      jegkocka: {
        ...
        review: { quote: 'My whiskey has taken me more seriously ever since.', author: 'David, occasional host' },
      },
      'avokado-kes': {
        ...
        review: { quote: 'My avocados finally look like they had a beauty budget.', author: 'Boroka, content creator' },
      },
      'wc-papir-tarto': {
        ...
        review: { quote: 'Home office now feels both truly home and truly office.', author: 'Tamas, middle manager' },
      },
      'fogkrem-adagolo': {
        ...
        review: { quote: 'Now I know the right amount. Before this, I only guessed.', author: 'Nora, aesthete' },
      },
      'habos-szappan': {
        ...
        review: { quote: 'Since foam entered my life, I feel cleaner and somehow more official.', author: 'Kristian, real estate agent' },
      },
      'zokni-rendezo': {
        ...
        review: { quote: 'For the first time ever, I know exactly how many socks I own.', author: 'Anna, organization maximalist' },
      },
      'mini-zseblampa': {
        ...
        review: { quote: 'I found my own key in total darkness. A personal victory.', author: 'Gergo, apartment resident' },
      },
      cuccfogo: {
        ...
        review: { quote: 'My nightstand now only hosts a plant. It deserves that promotion.', author: 'Lilla, sleep enthusiast' },
      },
      'kabel-rendezo': {
        ...
        review: { quote: 'My desk is no longer a battlefield. It is basically a gallery.', author: 'Bence, developer' },
      },
      'pomodoro-kocka': {
        ...
        review: { quote: 'I adore the 25-minute side. The 45 is still a life goal.', author: 'Hanna, writer' },
      },
      'monitor-led': {
        ...
        review: { quote: 'I postponed my ergonomic checkup. This lamp earned that confidence.', author: 'Dani, designer' },
      },
    };
